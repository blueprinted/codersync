...
class MenuController extends AdminbaseController {
	...
	/*备份菜单*/
    public function spmy_export_menuAction(){
	...
	/*生成菜单多语言包*/
    public function spmy_export_menu_langAction(){
    	$apps=sp_scan_dir(APP_PATH."*",GLOB_ONLYDIR);
    	foreach ($apps as $app){
    		if(is_dir(APP_PATH.$app)){
    			$lang_dirs=sp_scan_dir(APP_PATH."$app/Lang/*",GLOB_ONLYDIR);
    ...
    public function spmy_getactionsAction(){
