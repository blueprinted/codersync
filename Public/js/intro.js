...
(function (root, factory) {
  ...
  function IntroJs(obj) {
    ...
    this._options = {
      ...
      skipLabel: 'Skip',
	  /* Notagain button label in tooltip box */
	  notagainLabel: 'Not again',
	  notagainCallback: function(){},
  ...
  */
  ...
  function _showElement(targetElement) {
    ...
    if (oldHelperLayer != null) {
	  ...
	  //notagain button
	  var notTooltipButton = document.createElement('a');
      notTooltipButton.className = 'introjs-button introjs-notagainbutton';
      _setAnchorAsButton(notTooltipButton);
      notTooltipButton.innerHTML = this._options.notagainLabel;

      notTooltipButton.onclick = function() {
		if (self._introItems.length - 1 == self._currentStep && typeof (self._introCompleteCallback) === 'function') {
          self._introCompleteCallback.call(self);
        }
		...
		if(typeof self._options.notagainCallback == 'function')
			self._options.notagainCallback();
		return true;
      };

      buttonsLayer.appendChild(notTooltipButton);
