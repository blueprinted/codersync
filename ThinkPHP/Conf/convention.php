...
return  array(
    ...
    'SESSION_TYPE'          =>  '', // session hander类型 默认无需设置 除非扩展了session hander驱动 [Filer:自定义文件存储,Db:数据库存储,Memcache:memcache存储,Mysqli:mysqli存储]
	'SESSION_SAVE_PATH'		=>	'', // SESSION_TYPE=Filer时 session文件存储的目录
